...
- 制作世界人口地图： JSON 格式         
    ...
    - [获取两个字母的国别码](./项目2、数据可视化/16章、下载数据/country_codes.py)
    - [提取国家名和人口数量后，我们将国别码存储在code 中](./项目2、数据可视化/16章、下载数据/world_population3.py)
    - [制作世界地图](./项目2、数据可视化/16章、下载数据/americas.py)
    - [在世界地图上呈现数字数据](./项目2、数据可视化/16章、下载数据/na_populations.py)
...
- 使用 Pygal 可视化仓库            
    ...
    - [添加自定义工具提示](./项目2、数据可视化/17章、使用API/bar_descriptions.py)
    - [根据数据绘图, 并添加可单击的链接](./项目2、数据可视化/17章、使用API/python_repos07.py)
