...
- 随机漫步         
    - [一个生成随机漫步数据的类](./项目2、数据可视化/random_walk.py)      
    - [绘制随机漫步图](./项目2、数据可视化/rw_visual1.py)
    - [模拟多次随机漫步](./项目2、数据可视化/rw_visual2.py)
    - [给随机漫步点着色](./项目2、数据可视化/rw_visual3.py)
    - [重新绘制起点和终点](./项目2、数据可视化/rw_visual4.py)
    - [隐藏坐标轴](./项目2、数据可视化/rw_visual5.py)
    - [增加点数](./项目2、数据可视化/rw_visual6.py)
    - [隐藏坐标轴](./项目2、数据可视化/rw_visual5.py)
    
    
- 使用 Pygal 模拟掷骰子        
    - [表示一个骰子的类-模拟掷一个骰子](./项目2、数据可视化/die.py)            
    - [绘制直方图: 掷几次骰子，并将结果存储在一个列表中 | 分析结果-计算每个点数出现的次数](./项目2、数据可视化/die_visual1.py)            
    - [绘制直方图: 同时掷两个骰子10万次，统计计算每个点数出现的次数](./项目2、数据可视化/die_visual2.py)            
    - [绘制直方图: 同时掷两个面数不同的骰子，统计计算每个点数出现的次数](./项目2、数据可视化/die_visual3.py)            
